...
export namespace ContractHelpers {
    ...
    export namespace P256Verifier {
        export async function deploy(): Promise<P256Verifier> {
            return await ethers.deployContract("P256Verifier", await getOwner());
        }
    }

    export namespace CertificateVerifier {
        export async function deploy(p256Verifier: P256Verifier): Promise<V1CertificateVerifier> {
            const owner = await getOwner();
            return await ethers.deployContract(
                "V1CertificateVerifier",
                [owner, await p256Verifier.getAddress()],
                owner
            );
        }
        ...
        export async function addPlatformCAKey(certificateVerifier: V1CertificateVerifier) {
            await certificateVerifier
                .connect(await getOwner())
                .addPlatformCAKey(
                    platformCaCert.x,
        ...
        export async function addPCK(certificateVerifier: V1CertificateVerifier) {
            await certificateVerifier
                .connect(await getOwner())
                .addPCK(
                    processorPckCert.x,
    ...
    export namespace QuoteVerifier {
        export async function deploy(p256Verifier: P256Verifier, certificateVerifier: V1CertificateVerifier) {
            return await ethers.deployContract(
                "V1QuoteVerifier",
                [await p256Verifier.getAddress(), await certificateVerifier.getAddress()],
                await getOwner()
            );
        }
        ...
        export async function createConfigured() {
            ...
            await CertificateVerifier.addRootKey(certificateVerifier);
    ...
    export namespace TrustDomainRegistry {
        export async function createConfigured() {
            ...
            await addTD(trustDomainRegistry);
            await allowTD(trustDomainRegistry);
        ...
        export async function deploy(quoteVerifier: V1QuoteVerifier) {
            ...
            return await ethers.deployContract(
                "V1TrustDomainRegistry",
                [owner, await quoteVerifier.getAddress()],
                owner
            );
        }
