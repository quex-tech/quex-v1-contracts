...
contract P256VerifierFacet is IP256Verifier {
    ...
    uint256 private constant MINUS_2MODN = 0xFFFFFFFF00000000FFFFFFFFFFFFFFFFBCE6FAADA7179E84F3B9CAC2FC63254F;

    /**
     * @dev ECDSA verification given signature and public key.
     */
    function ecdsaVerify(bytes32 messageHash, uint256 r, uint256 s, uint256[2] calldata pubKey)
        external
        view
        returns (bool)
    {
        ...
        uint256 rX = ecZZMulmuladd(pubKey[0], pubKey[1], scalarU, scalarV);
        return rX % N == r;
    }
     ...
     */
    function ecAffIsValidPubkey(uint256 x, uint256 y) internal pure returns (bool) {
        if (x >= P || y >= P || (x == 0 && y == 0)) {
            return false;
        }
    ...
    function ecAffSatisfiesCurveEqn(uint256 x, uint256 y) internal pure returns (bool) {
     ...
     */
    function ecAffAdd(uint256 x1, uint256 y1, uint256 x2, uint256 y2) internal view returns (uint256, uint256) {
     ...
     */
    function ecAffIsInf(uint256 x, uint256 y) internal pure returns (bool flag) {
     ...
     * Assumes point is on the EC or is the point at infinity.
     */
    function ecZZIsInf(uint256 zz, uint256 zzz) internal pure returns (bool flag) {
     ...
     */
    function ecZZDaddAffine(uint256 x1, uint256 y1, uint256 zz1, uint256 zzz1, uint256 x2, uint256 y2)
        internal
        pure
     ...
     */
    function ecZZDoubleZz(uint256 x1, uint256 y1, uint256 zz1, uint256 zzz1)
        internal
        pure
        returns (uint256 x3, uint256 y3, uint256 zz3, uint256 zzz3)
    {
     ...
     * Handles point at infinity gracefully
     */
    function ecZZDoubleAffine(uint256 x1, uint256 y1)
        internal
        pure
        returns (uint256 x3, uint256 y3, uint256 zz3, uint256 zzz3)
    {
     ...
     */
    function ecZZSetAff(uint256 x, uint256 y, uint256 zz, uint256 zzz) internal view returns (uint256 x1, uint256 y1) {
        if (ecZZIsInf(zz, zzz)) {
